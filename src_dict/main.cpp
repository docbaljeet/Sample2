...
int main() {
    ...
    hooks.mortality  = load_hook("mortality_script_dict",  "calc");
    hooks.lapse      = load_hook("lapse_script_dict",      "calc");
    hooks.eia_credit = load_hook("eia_credit_script_dict", "calc");
    ...
    // ── Run projection ──────────────────────────────────────────────
    std::cout << "\n=== Running projection — dict marshalling ("
